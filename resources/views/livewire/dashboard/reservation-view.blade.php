<div class="content-body">
    ...
    {{-- Modals --}}
    @include('livewire.dashboard.__partials.bookings.__book_room')
    @include('livewire.dashboard.__partials.bookings.__respond_reservation')
</div>
