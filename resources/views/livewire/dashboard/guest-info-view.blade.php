                                            ...
                                            <div class="guest-profile">
                                                ...
                                                <div class="d-flex">
                                                    <div class="mt-4 check-status">
                                                        ...
                                                        <span class="font-w500 fs-16">{{ App\Models\User::lastCheckInDate($user->id)  }}</span>
                                                    </div>
                                                    &nbsp;
                                                    <div class="mt-4">
                                                        <span class="d-block mb-2">Check Out</span>	
                                                        <span class="font-w500 fs-16">{{ App\Models\User::lastCheckOutDate($user->id) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            @else
                                                ...
                                                <div class="item">
                                                    <div class="rooms">
                                                        ...
                                                        <div class="img-content">
                                                            <h4 class="fs-24 font-w500 text-priamry">No Bookings</h4>
                                                            <p class="text-secondary">Customer has no booking yet.</p>	
                                                        </div>
                                                    </div>
                                                </div>
                                                @endif
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-header bg-primary border-0">
                                    <h4 class="fs-20 text-white">Booking History</h4>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-xl-4 col-sm-7">
                                                <div class="purchase-history d-flex align-items-center">
                                                    ...
                                                    <img class="rounded" width="100" src="{{ '../public/'.Storage::url($book->room->room_types->cover) }}" alt="">
                                                    @else
                                                    <img class="rounded" width="100" src="data:image/png;base64," alt="">
                                                    @endif 
                                                    <div class="ms-3">
