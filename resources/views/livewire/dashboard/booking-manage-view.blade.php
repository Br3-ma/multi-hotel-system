<div class="content-body">
                        ...
                        <div class="tab-content">	
                            <div class="tab-pane fade active show" id="AllRooms">
                                <div class="table-responsive">
                                    ...
                                    <table wire:loading.remove wire:ignore.self wire:poll.100000ms class="table card-table display mb-4 shadow-hover table-responsive-lg" id="guestTable-all3">
                                        <thead>
                                            <tr>
                                                <th class="bg-none">
    ...
    {{-- Modals --}}
    @include('livewire.dashboard.__partials.bookings.__new_booking')
</div>
