    ...
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card gradient-1 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $tt_booking }}</h2>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-2 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $tt_lodges }}</h2>
                            <span class="fs-18">Lodges</span>
                        </div>
                        <svg width="58" height="58" viewBox="0 0 58 58" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-3 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $tt_rooms }}</h2>
            ...
            <div class="col-xl-3 col-sm-6">
                <div class="card gradient-4 card-bx">
                    <div class="card-body d-flex align-items-center">
                        <div class="me-auto text-white">
                            <h2 class="text-white">{{ $tt_inquiries }}</h2>
                            <span class="fs-18">Inquiries</span>
                        </div>
        ...
        <div class="row">
            {{-- <div class="col-xl-12 col-xxl-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-intro-title">Bookings Calendar</h4>
                        Should have tooltips or text showing lodge relation to events
                        <div class="">
                    ...
                    <div class="col-xl-12 col-sm-6">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <h2>{{ $tt_rooms_available }}</h2>
                                <span class="fs-16 text-black">Available Rooms Today</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-12">
                    ...
                    <div class="card-header border-0 d-sm-flex d-block">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="d-flex me-5">
                                <h3 class="mb-0 me-2">{{ $tt_in }}</h3>
                                <span>Check In</span>
                            </div>
                            <div class="d-flex me-3">
                                <h3 class="mb-0 me-2">{{ $tt_out }}</h3>
                                <span>Check Out</span>
                            </div>
                            <div class="dropdown">
                            ...
                            @forelse ($bookings as $b)
                                <div class="col-xl-6 col-sm-6">
                                    <div class="dz-image-bx rounded">
                                        ...
                                        <div class="dz-info">
                                            <h5>{{ App\Models\Reservation::fullName($b->guests_id) ?? 'Guest'}}</h5>
                                            <span class="text-primary">{{$b->created_at->toFormattedDateString()}}</span>
                                            <div class="d-flex flex-wrap mt-3">
                                                <span class="me-auto pe-3">Room {{ $b->room->room_number }}</span>
                                                <span class="me-auto pe-3">{{ $b->room->room_types->name }}</span>
                                                <span class="me-auto pe-3">{{ $b->room->room_types->bed_type }}</span>
                                                <span>{{ $b->num_adults + $b->num_children}} Person</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header border-0">
                                <h4 class="card-title">Latest Customer Inquiries</h4>
                                {{-- <div class="dropdown">
                                    <a href="javascript:void(0);" class="btn-link" data-bs-toggle="dropdown" aria-expanded="false">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <div class="card-body customer-review-bx p-0 dz-scroll loadmore-content" id="customerReviewContent">
                                @forelse ($inquries as $i )
                                <div class="dz-review-bx">
                                    {{-- <img class="dz-media me-4" src="images/avatar/1.jpg" alt=""> --}}
                                    <div class="dz-info">
                                        <div class="dz-name mb-3">
                                            <div>
                                                <h6 class="title mb-1">{{ App\Models\Reservation::fullName($i->guests_id)}}</h6>
                                                <span class="date text-black op8">Posted on {{ $$i->created_at->toFormattedDateString()}}</span>
                                            </div>
                                        ...
                                        <div class="dz-footer">
                                            <p class="text-black op8 mb-sm-0 mb-3 me-4">
                                                I Would to make a reservation on a {{ $i->room_type }} room for a total of {{ $i->num_adults + $i->num_children }} people from {{ $i->checkin_date }} to {{ $i->checkout_date }}.
                                            </p>
                                            <p class="text-black op8 mb-sm-0 mb-3 me-4">
                                                Special Requests: {{ $i->special_requests }}.
                                            </p>
                            ...
                            {{-- <div class="card-footer style-1 border-0 pt-0 text-center">
                                <a href="javascript:void(0);" class="dz-load-more fas fa-chevron-down" id="customerReview" rel="ajax/customer-review.php"></a>
                            </div> --}}
                        </div>
                    </div>
                </div>
